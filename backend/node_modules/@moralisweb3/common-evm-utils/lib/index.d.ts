...
interface EvmBlockTokenStatTokenTransfersJSON {
    readonly total: string;
}
interface EvmBlockTokenStatTokenTransfersInput {
    readonly total: string;
}
declare class EvmBlockTokenStatTokenTransfers {
    static create(input: EvmBlockTokenStatTokenTransfersInput | EvmBlockTokenStatTokenTransfers): EvmBlockTokenStatTokenTransfers;
    static fromJSON(json: EvmBlockTokenStatTokenTransfersJSON): EvmBlockTokenStatTokenTransfers;
    /**
     * @description The number of ERC20 token transfers made in a block
     */
    readonly total: string;
    private constructor();
    toJSON(): EvmBlockTokenStatTokenTransfersJSON;
}
...
declare class EvmBlockTokenStat {
     ...
     * @description Token transfer stats
     */
    readonly tokenTransfers: EvmBlockTokenStatTokenTransfers;
    private constructor();
