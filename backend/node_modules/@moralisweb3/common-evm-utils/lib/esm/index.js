...
var EvmBlockTokenStatTokenTransfers = /** @class */ (function () {
    function EvmBlockTokenStatTokenTransfers(input) {
        this.total = input.total;
    }
    EvmBlockTokenStatTokenTransfers.create = function (input) {
        if (input instanceof EvmBlockTokenStatTokenTransfers) {
            return input;
        }
        return new EvmBlockTokenStatTokenTransfers(input);
    };
    EvmBlockTokenStatTokenTransfers.fromJSON = function (json) {
        var input = {
            total: json.total,
        };
        return EvmBlockTokenStatTokenTransfers.create(input);
    };
    EvmBlockTokenStatTokenTransfers.prototype.toJSON = function () {
        return {
            total: this.total,
        };
    };
    return EvmBlockTokenStatTokenTransfers;
}());
